    ...
    return (
        <View style={{backgroundColor: theme.colors.primary, flex: 1}}>
            ...
            <LogoTemplate style={{ width:400, height:400}}/>
                <TextTemplate onLongPress={props.func} variant="headlineLarge" style={{flex:1,color: theme.colors.secondary, fontSize: 42}}>Planifécation</TextTemplate>
                <ActivityIndicator
                style={{flex: 2}} color={theme.colors.error} size={150}></ActivityIndicator>
            </View>
        </View>
    );
}