import {
  ...
  export const getDate = CalendarUtils.getCalendarDateString(new Date().setDate(today.getDate()));
  export const INITIAL_TIME = {hour : today.getHours(), minutes : today.getMinutes()};
